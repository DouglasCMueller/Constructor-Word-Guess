...
function buildWord() {
  ...
  var sportNames = ["soccer","hockey","squash"];
var randomIndex = Math.floor(Math.random() * sportNames.length);
var gameWord = sportNames[randomIndex];
  ...
  console.log(actualWord.gameWord);
